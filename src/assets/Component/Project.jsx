...
const Project = () => {
  return (
    <div className="flex  justify-between bg-gray-100 px-6  h-auto rounded-lg shadow-lg ">
      ...
      <div className="w-[33%] border-2 bg-white rounded-2xl p-4 shadow-lg">
  {/* Project Overview */}
  ...
  <div className="relative flex justify-center items-center pt-16">
    ...
    <div className="absolute w-40 h-40 rounded-full border-4 border-t-4 border-blue-500 border-r-4 border-gray-200 animate-spin duration-1000 ease-in-out"></div>
    <div className="absolute w-36 h-36 rounded-full border-4 border-t-4 border-green-500 border-r-4 border-gray-200 animate-spin duration-1000 ease-in-out"></div>
    <div className="absolute w-32 h-32 rounded-full border-4 border-t-4 border-purple-600 border-r-4 border-gray-200 animate-spin duration-1000 ease-in-out"></div>
    <div className="absolute w-28 h-28 rounded-full border-4 border-t-4 border-orange-500 border-r-4 border-gray-200 animate-spin duration-1000 ease-in-out"></div>
    <div className="absolute w-24 h-24 rounded-full border-4 border-t-4 border-pink-500 border-r-4 border-gray-200 animate-spin duration-1000 ease-in-out"></div>
