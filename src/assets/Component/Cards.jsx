...
const Cards = () => {
  return (
    <div className="flex flex-wrap gap-4 justify-between bg-gray-100 px-4 py-6 border-2">
      {/* Card Component */}
      {Array(4).fill("").map((_, index) => (
        <div key={index} className="w-full sm:w-[48%] md:w-[30%] lg:w-[23%] p-5 rounded-[20px] shadow-lg bg-white">
